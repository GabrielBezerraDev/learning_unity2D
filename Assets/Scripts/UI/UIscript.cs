...
public class UIscript : MonoBehaviour
{
    ...
    //    else
    //    {
    //        Debug.LogError("O componente BaseCharacter n�o foi encontrado no prefab instanciado.");
    //    }
    //}
